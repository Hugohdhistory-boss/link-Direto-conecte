const CACHE_NAME='link-direto-v11-social';
const ASSETS=['./','./index.html','./styles.css','./cover-v5.css','./v6-enhancements.css','./v7-auth.css','./v8-notifications.css','./v9-tech.css','./v10-black.css','./v11-social.css','./app.js','./manifest.json','./icon-192.png','./icon-512.png','./capa-link-direto-v5.png'];
...
self.addEventListener('notificationclick',event=>{
  ...
  event.waitUntil(clients.matchAll({type:'window',includeUncontrolled:true}).then(windows=>{
    ...
    return clients.openWindow('./?v=11');
  }));
});
