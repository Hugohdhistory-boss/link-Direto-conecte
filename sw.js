...
const CACHE_NAME='link-direto-v20-match-v1';
const ASSETS=['./','./index.html','./styles.css','./cover-v5.css','./v6-enhancements.css','./v7-auth.css','./v8-notifications.css','./v9-tech.css','./v10-black.css','./v11-social.css','./v12-profile.css','./v14-install-chat.css','./v15-commercial-news.css','./v16-growth-market.css','./v16-smart-news.css','./v16-7-discover.css','./v17-jobs.css','./v18-home-focus.css','./v19-match.css','./app.js','./manifest.json','./icon-192.png','./icon-512.png','./capa-link-direto-v161.png'];
...
self.addEventListener('notificationclick',event=>{
  ...
  event.waitUntil(clients.matchAll({type:'window',includeUncontrolled:true}).then(windows=>{
    ...
    return clients.openWindow('./?v=19');
  }));
});
