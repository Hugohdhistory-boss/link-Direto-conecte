...
function editProfile(){
  ...
  // Mostra o formulário imediatamente, sem depender apenas do estado visual anterior.
  $('profileSummary')?.classList.add('hidden');
  $('profileGuest')?.classList.add('hidden');
  $('profileForm')?.classList.remove('hidden');

  try{renderProfile()}catch(err){
    console.error('edit profile render',err);
    $('profileSummary')?.classList.add('hidden');
    $('profileForm')?.classList.remove('hidden');
  }
